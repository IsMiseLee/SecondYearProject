...
"""),format.raw/*12.1*/("""<div class="row">
	...
	<div class="col-md-12">
		...
		"""),format.raw/*21.3*/("""<table class="table">
			<thead>
			<!-- The header row-->
			<tr>
				<th>Album name</th>
			...
			<tbody>
                """),_display_(/*33.18*/if(order != null)/*33.35*/ {_display_(Seq[Any](format.raw/*33.37*/("""
                    ...
                    """),format.raw/*36.21*/("""<tr>
                        ...
                        <td>"""),_display_(/*38.30*/i/*38.31*/.getProduct.getArt_name),format.raw/*38.54*/("""</td>
        ...
        <div class="row">
            <div class="col-md-12">
                <p class="text"><strong>Order Total: &euro; """),_display_(/*49.62*/("%.2f".format(order.getOrderTotal))),format.raw/*49.98*/("""</strong></p>
            </div>  
...
""")))}))
  ...
  def ref: this.type = this
              ...
              /*
                  -- GENERATED --
                  DATE: Sun Apr 22 21:03:11 IST 2018
                  SOURCE: /home/wdd/webapps/SecondYearProject/app/views/orderConfirmed.scala.html
                  HASH: 8f6e2bace9203cc6ce1a76dddf02ac18b3ec699e
                  MATRIX: 998->1|1138->72|1174->102|1206->128|1260->68|1289->153|1316->154|1387->200|1431->236|1470->238|1500->241|1573->288|1614->320|1654->322|1687->328|1758->372|1772->377|1808->392|1841->398|1881->408|1913->413|2182->655|2208->672|2248->674|2297->695|2407->778|2447->802|2487->804|2536->825|2597->859|2607->860|2653->885|2715->920|2725->921|2769->944|2838->986|2886->1013|2948->1048|2958->1049|2993->1063|3062->1105|3114->1136|3198->1189|3269->1229|3300->1233|3470->1376|3527->1412
