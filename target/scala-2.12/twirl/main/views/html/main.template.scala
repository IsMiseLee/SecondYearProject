...
<html lang="en">
    ...
    <body>
        ...
        """),format.raw/*59.9*/("""<script src=""""),_display_(/*59.23*/routes/*59.29*/.Assets.versioned("javascripts/main.js")),format.raw/*59.69*/("""" type="text/javascript"></script>
    </body>
</html>
"""))
      }
