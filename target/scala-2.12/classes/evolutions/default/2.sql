...
insert into artist (id,name,genre,city,country) values (3,'Metallica','Trash metal','CA','USA');

insert into member (email,name,password,role) values ( 'admin@AuralSoul.com', 'Lee Admin', 'password', 'admin' );
insert into member (email,name,password,role) values ( 'customer@AuralSoul.com', 'Sean Customer', 'password', 'customer' );

insert into artist_product (artist_id,product_id) values (1,1);
insert into artist_product (artist_id,product_id) values (2,2);
insert into artist_product (artist_id,product_id) values (3,3);
